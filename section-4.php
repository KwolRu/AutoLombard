<section class="faq">
    <div class="container">
        <h2 class="title-h2">Ответы на вопросы</h2>
        <div class="row">
                ...
                <div class="col-sm-6 col-lg-6 col-sm-12 faq border-block-questions">
                    <ul class="faq-questions">
                        ...
                        <li class="questions-block">
                            ...
                            <p class="faq-answer">Процесс обычно начинается с встречи с дизайнером для обсуждения ваших требований и предпочтений. Затем дизайнер создает предварительный план дизайна, который обсуждается и корректируется по мере необходимости. После утверждения плана дизайнер помогает в выборе материалов и отделки.</p>
                        </li>
                        ...
                        <li class="questions-block">
                            ...
                            <div class="flex">
                                <div class="icon"> <img src="assets/img/information.png" alt=""> </div>
                                <h4 class="faq-question"> Могу ли я вносить изменения в экспресс дизайн проект?</h4>
                                <div class="icon-arrow"> <img src="assets/img/arrow.svg" alt=""> </div>

                            </div>
                            <p class="faq-answer">Да, вы можете вносить изменения в проект на протяжении всего процесса. Ваш дизайнер будет работать с вами, чтобы убедиться, что проект отвечает всем вашим требованиям и предпочтениям.</p>
                        </li>
                    </ul>
                </div>
